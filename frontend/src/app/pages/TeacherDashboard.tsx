...
export function TeacherDashboard() {
  ...
  useEffect(() => {
    courseService
      .getAll({ teacherId: MOCK_USER_IDS.teacher })
      .then((all) => setCourses(all.slice(0, 5)));
  }, []);
                  ...
                  <Card className="p-6 hover:shadow-lg transition-shadow bg-card/50">
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {course.semester} · {course.visibility}
                        </p>
                      </div>
                      <Button asChild>
                    ...
                    <div className="grid grid-cols-4 gap-4 text-sm">
                      <div>
                        ...
                        <div className="font-mono font-semibold text-sm">{course.courseCode}</div>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <div className="font-semibold text-lg">
                          {course.enrolledCount}{course.maxStudents ? ` / ${course.maxStudents}` : ''}
                        </div>
                      </div>
                      <div>
