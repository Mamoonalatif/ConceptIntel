...
import { CourseCoordinatorOverviewPage } from './pages/CourseCoordinatorOverviewPage';
...
export const router = createBrowserRouter([
...

  {
    ...
    children: [
      ...
      // Coordinator supervises one assigned course but doesn't create/own
      // offerings ("classes") themselves — read-only info page, not MyCoursesPage.
      { path: 'courses', Component: CourseCoordinatorOverviewPage },
    ],
  },

  {
    ...
    children: [
      { path: 'dashboard', Component: CurriculumIntelligenceDashboard },
      // HOD decides what's in the program catalog — not course offerings.
      { path: 'courses', Component: CatalogManagementPage },
    ],
  },
