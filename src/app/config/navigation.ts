...
export const teacherNavItems: NavItem[] = [
  ...
  { title: 'AI Supervision', href: '/teacher/supervision', icon: ClipboardCheck },
...
export const studentNavItems: NavItem[] = [
  ...
  { title: 'My Learning', href: '/student/course/course_dsa_101', icon: BookOpen },
  { title: 'Adaptive Path', href: '/student/course/course_dsa_101/adaptive', icon: Brain },
...
export const coordinatorNavItems: NavItem[] = [
  ...
  { title: 'AI Supervision', href: '/coordinator/supervision', icon: ClipboardCheck },
